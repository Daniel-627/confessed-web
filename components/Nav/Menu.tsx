  ...
  return (
    <>
      <style>{`
        ...
        .menu-link.active::before { content: '✝'; color: #C9A94A; font-size: 14px; font-family: var(--font-barlow), sans-serif; }
        .menu-link-badge {
          font-size: 9px;
          font-weight: 700;
          letter-spacing: .1em;
        ...
        .menu-auth-btn.ghost { background: transparent; border: 1px solid rgba(255,255,255,0.12); color: rgba(240,236,224,0.65); }
