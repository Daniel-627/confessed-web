  ...
  return (
    <>
      <style>{`
        ...
        .ct-left {
          padding: 96px 64px; border-right: 1px solid rgba(255,255,255,0.05);
          display: flex; flex-direction: column;
        }
        .ct-eyebrow { display: flex; align-items: center; gap: 10px; margin-bottom: 28px; }
        ...
        .ct-title {
          ...
          line-height: 1.15; color: #f0ece0; margin-bottom: 20px;
        }
        .ct-title em { font-style: italic; color: #C9A94A; }
        .ct-lead {
          font-family: var(--font-garamond), serif; font-size: 17px;
          line-height: 1.8; color: rgba(240,236,224,0.5); margin-bottom: 48px;
        }
        .ct-info-block { margin-bottom: 32px; }
        .ct-info-label {
          font-size: 10px; font-weight: 700; letter-spacing: .16em;
          text-transform: uppercase; color: rgba(201,169,74,0.5); margin-bottom: 6px;
        }
        .ct-info-value { font-size: 14px; color: rgba(240,236,224,0.6); }
        .ct-info-value a { color: #C9A94A; text-decoration: none; }
        .ct-info-value a:hover { text-decoration: underline; }
        .ct-note {
          margin-top: auto; font-family: var(--font-garamond), serif;
          font-size: 14px; font-style: italic; color: rgba(240,236,224,0.2); line-height: 1.7;
        }
        .ct-right { padding: 96px 64px; display: flex; flex-direction: column; }
        ...
        .ct-input, .ct-select, .ct-textarea {
          ...
          transition: border-color .2s; caret-color: #C9A94A;
          box-sizing: border-box;
        }
        .ct-input:focus, .ct-select:focus, .ct-textarea:focus {
          border-color: rgba(201,169,74,0.4);
        }
        .ct-input::placeholder, .ct-textarea::placeholder { color: rgba(240,236,224,0.2); }
        ...
        .ct-success {
          display: flex; flex-direction: column;
          align-items: flex-start; gap: 16px; padding: 40px 0;
        }
        .ct-success-cross { color: #C9A94A; font-size: 32px; }
        .ct-success-title { font-family: var(--font-garamond), serif; font-size: 28px; color: #f0ece0; }
        .ct-success-body {
          font-family: var(--font-garamond), serif; font-size: 17px;
          font-style: italic; color: rgba(240,236,224,0.5); line-height: 1.7;
        }
      ...
      <div className="ct-wrap">
        <div className="ct-left">
          ...
          <div className="ct-info-block">
            ...
            <p className="ct-info-value"><a href="mailto:hello@confessed.faith">hello@confessed.faith</a></p>
          </div>
          <div className="ct-info-block">
          ...
          <div className="ct-info-block">
            ...
            <p className="ct-info-value"><a href="https://x.com/ConfessedFaith" target="_blank" rel="noopener">@ConfessedFaith</a></p>
          </div>
          <div className="ct-info-block">
          ...
          <p className="ct-note">"Iron sharpens iron, and one man sharpens another." — Proverbs 27:17</p>
        </div>
          ...
          {sent ? (
            ...
            <div className="ct-form">
              <div>
                ...
                <input className="ct-input" placeholder="Your full name" value={name} onChange={e => setName(e.target.value)} />
              </div>
              <div>
                <label className="ct-field-label">Email *</label>
                <input className="ct-input" type="email" placeholder="your@email.com" value={email} onChange={e => setEmail(e.target.value)} />
              </div>
              <div>
                <label className="ct-field-label">Reason for contact</label>
                <select title="select" className="ct-select" value={reason} onChange={e => setReason(e.target.value)}>
              ...
              <div>
                ...
                <textarea className="ct-textarea" placeholder="Write your message here…" value={message} onChange={e => setMessage(e.target.value)} />
              </div>
